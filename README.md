...
| `docs/Speaker_Companion.pdf` | **Presenter script** — one page-section per slide, amber “SAY” lines to read aloud + grey backup for questions. Regenerate from `docs/companion.html`. |
